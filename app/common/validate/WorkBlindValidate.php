...
class WorkBlindValidate extends BaseValidate
{
    protected $rule =   [
        'id'                    => 'require|integer',
...
//        'work_level_id'         => 'require|integer',
        ...
        'blind_no'              => 'require|max:255',
        'blind_spec'            => 'require|max:255',
        'blind_material'        => 'require|max:255',
        'reason'                => 'require|max:255',
        'device_name'           => 'require|max:255',
        'medium'                => 'require|max:255',
        'pressure'              => 'require|integer',
        'temp'                  => 'require|float',
        'block_effective_date'  => 'require|date',
        'pump_effective_date'   => 'require|date',
